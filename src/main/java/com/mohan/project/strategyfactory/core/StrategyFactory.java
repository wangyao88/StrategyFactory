...
public final class StrategyFactory {
    ...
    static void registerOneArg(OneArgStrategy strategy) {
    ...
    static void registerTwoArg(TwoArgStrategy strategy) {
        String name = strategy.getClass().getName();
    ...
    static void registerThreeArg(ThreeArgStrategy strategy) {
        String name = strategy.getClass().getName();
